...
Kode ini berfungsi untuk menampilkan output menu utama (list semua musik, tambah musik, ubah musik, hapus musik, rekomendasi genre, dan keluar) dan untuk menerapkan input angka dari 1-6
